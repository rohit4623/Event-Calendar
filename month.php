...
function month_table_innerhtml($day, $month, $year, $room, $area)
{
  ...
  // This data will be retrieved day-by-day fo the whole month
    ...
    //$areanames = get_area_names();
    //$areaids = get_area_ids();
    ...
    //foreach ($areaids as $area) {
        ...
        foreach ($rooms as $room) {
            for ($day_num = 1; $day_num <= $days_in_month; $day_num++) {
                ...
                $entries = get_entries_by_room($room['id'], $start_first_slot, $end_last_slot);
...
echo "<div id=\"dwm\">\n";
echo "<h2>" . utf8_strftime($strftime_format['monthyear'], $month_start) . "</h2>\n";
echo "</div>\n";
