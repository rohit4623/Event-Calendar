...
$limit = get_status_count($user);
if($limit > 2) {
    echo "<script type=\"text/javascript\">window.alert('Please upload previous 3 Events Status update');window.location.href = 'month.php';</script>";
}
...
foreach ($edit_entry_field_order as $key)
{
  ...
  case 'privacy_status':
    ...
    break;
  case 'students_attended':
  case 'event_report':
  case 'image_path':
    break;						//Change Sagar Skip these custom fields.
  default:
